##' Calculate Singal Times
##'
##' @title Calculate Singal Times
...
##' (1) Times to Signals, a numeric vector. \cr
##' (2) Whether the subject received sigals, a logical vector.
##' @author LY
##' @export
##' @examples 
eva_calculate_signal_times<-function(
